			...
			<form action="" id="manage_customer">
				...
				<div class="row">
					<div class="col-md-12 border-right">
						...
						<div class="form-group col-md-3 float-left">
							...
							<input type="date" name="date_created" class="form-control form-control-sm" required value="<?php echo isset($date_created) ? $date_created : '' ?>">
						</div>
						<div class="form-group col-md-3 float-left">
						...
						<div class="form-group col-md-6 float-left">
							...
							<textarea name="characteristics"  style="width: 100%; height: 80px"> </textarea>
						</div>
						...
						<div class="form-group col-md-3 float-left">
							...
							<input type="text" name="discipline" class="form-control form-control-sm solonumeros" required value="<?php echo isset($discipline) ? $discipline : '' ?>">
						</div>
				...
				<div class="row">	
					<div class="col-md-12">
						...
						<div class="form-group col-md-12">
							...
							<input type="text" class="form-control form-control-sm" name="invoice" required value="<?php echo isset($invoice) ? $invoice : '' ?>">
							<small id="#msg"></small>
						</div>
						<div class="form-group col-md-4 float-left">
							<label class="control-label">Comodato</label>
						<input type="file" accept="application/pdf" class="form-control form-control-sm" name="bailment_file">						
						</div>

						<div class="form-group col-md-4 float-left">
							<label class="control-label">Contrato M</label>
						<input type="file" accept="application/pdf" class="form-control form-control-sm" name="contract_file">						
						</div>

						<div class="form-group col-md-4 float-left">
							<label class="control-label">Manual Usuario</label>
						<input type="file"  accept="application/pdf" class="form-control form-control-sm" name="usermanual_file">						
						</div>

						<div class="form-group col-md-4 float-left">
							<label class="control-label">Guia Rapida</label>
						<input type="file" accept="application/pdf" class="form-control form-control-sm" name="fast_guide_file">						
						</div>
						<div class="form-group col-md-4 float-left">
							<label class="control-label">Ficha Tecnica</label>
						<input type="file" accept="application/pdf" class="form-control form-control-sm" name="datasheet_file">						
						</div>
						<div class="form-group col-md-4 float-left">
						<label class="control-label">Man Servicios</label>
						<input type="file" accept="application/pdf" class="form-control form-control-sm" name="servicemanual_file">						
						</div>
					</div>
				...
				<div class="row">
					 <div class="col-md-12 border-right">
						...
						<div class="form-group col-md-4 float-left">
							...
							<?php 
							$departments = $conn->query("SELECT * FROM `equipment_deparments` order by `id` asc ");
						...
						<div class="form-group col-md-4 float-left">
							...
							<?php 
							$locations = $conn->query("SELECT * FROM `equipment_locations` order by `id` asc ");
						...
						<div class="form-group col-md-4 float-left">
							...
							<?php 
							$responsible_positions = $conn->query("SELECT * FROM `equipment_responsible_positions` order by `id` asc ");
							while($row = $responsible_positions->fetch_assoc()):
							?>
								<option value="<?php echo $row['id'] ?>" ><?php echo $row['name'] ?></option>
							<?php endwhile; ?>
						...
						<div class="form-group col-md-4 float-left">
							...
							<input type="date" name="date_training" class="form-control form-control-sm" required value="<?php echo isset($date_training) ? $date_training : '' ?>">
						</div>
				...
				<div class="row">
						...
						<div class="form-group col-md-4 float-left">
							...
							<input type="text" name="email" class="form-control form-control-sm" required value="<?php echo isset($email) ? $emial : '' ?>">
						</div>
						<div class="form-group col-md-4 float-left">
						...
						<div class="form-group col-md-4 float-left">
							...
							<input type="date" name="date_adquisition" class="form-control form-control-sm" required value="<?php echo isset($date_adquisition) ? $date_adquisition : '' ?>">
						</div>
