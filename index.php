...
<head>
  ...
  <title>System V1 | Dashboard </title>
...
<body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
  ...
  <div class="app-wrapper">
    <!--begin::Header | aqui va el codigo del navbar-->
    <?php include 'components/navbar.php'; ?>

    <!--end::Header-->
    <!--Aqui va el codigo del sidebar-->
  ...
  <!--begin::App Main-->
  <main class="app-main">
    <!--begin::App Content Header| Probando mover el codigo a home-->
    <div class="app-content-header">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-sm-6">
            <h3 class="mb-0">Welcome User to your Dashboard </h3>
          </div>
          <div class="col-sm-6">
