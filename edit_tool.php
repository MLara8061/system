                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="nombre" name="nombre" class="form-control" 
                                   value="<?php echo $tool['nombre']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="marca">Marca</label>
                            <input type="text" id="marca" name="marca" class="form-control" 
                                   value="<?php echo $tool['marca']; ?>">
                        </div>

                        <div class="form-group">
                            <label for="cantidad">Cantidad</label>
                            <input type="number" id="cantidad" name="cantidad" class="form-control" 
                                   min="1" value="<?php echo $tool['cantidad']; ?>" required>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="fecha_baja" name="fecha_baja" class="form-control" 
                                   value="<?php echo $tool['fecha_baja']; ?>">
                        </div>

                        <div class="form-group">
                            <label for="caracteristicas">Características</label>
                            <textarea id="caracteristicas" name="caracteristicas" rows="4" class="form-control"><?php echo $tool['caracteristicas']; ?></textarea>
                        </div>
...
// Eliminar imagen actual y permitir cargar nueva
    ...
    $.ajax({
        ...
        success: function(resp){
            ...
            if(resp == 1){
                ...
                alert_toast('Error al actualizar herramienta','error');
            }
        },
        error: function(){
            end_load();
