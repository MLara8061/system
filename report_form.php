                ...
                <div class="report-form">
                    <form action="generate_pdf.php" method="POST" id="reporteForm" target="_blank">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4"><input type="text" class="form-control form-control-sm" name="cliente_nombre" required></div>
                                    <label class="col-sm-2 col-form-label">TEL:</label>
                                    <div class="col-sm-4"><input type="text" class="form-control form-control-sm" name="cliente_tel"></div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">DOMICILIO:</label>
                                    <div class="col-sm-6"><input type="text" class="form-control form-control-sm" name="cliente_domicilio"></div>
                                    <label class="col-sm-1 col-form-label">E-MAIL:</label>
                                    <div class="col-sm-3"><input type="email" class="form-control form-control-sm" name="cliente_email"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">SELECCIONE EQUIPO:</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">NOMBRE:</label>
                                    <div class="col-sm-4"><input type="text" class="form-control form-control-sm" name="equipo_nombre" id="equipo_nombre" readonly></div>
                                    <label class="col-sm-2 col-form-label">MARCA:</label>
                                    <div class="col-sm-4"><input type="text" class="form-control form-control-sm" name="equipo_marca" id="equipo_marca" readonly></div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">MODELO:</label>
                                    <div class="col-sm-4"><input type="text" class="form-control form-control-sm" name="equipo_modelo" id="equipo_modelo" readonly></div>
                                    <label class="col-sm-2 col-form-label">SERIE:</label>
                                    <div class="col-sm-4"><input type="text" class="form-control form-control-sm" name="equipo_serie" id="equipo_serie" readonly></div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">INVENTARIO:</label>
                                    <div class="col-sm-4"><input type="text" class="form-control form-control-sm" name="equipo_inventario" id="equipo_inventario" readonly></div>
                                    <label class="col-sm-2 col-form-label">UBICACIÓN:</label>
                                    <div class="col-sm-4"><input type="text" class="form-control form-control-sm" name="equipo_ubicacion" id="equipo_ubicacion" readonly></div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <label class="d-block">Tipo de Servicio:</label>
                                ...
                                <div class="form-check form-check-inline"><input class="form-check-input" type="radio" name="tipo_servicio" value="SOPORTE TECNICO"><label class="form-check-label">SOPORTE TÉCNICO</label></div>
                            ...
                            <div class="col-12 mt-3">
                                <label class="d-block">Ejecución:</label>
                        ...
                        <div class="section-header d-flex justify-content-between align-items-center">
                            REFACCIONES
                            <button type="button" class="btn btn-success btn-sm" id="add_refaccion_btn">
                        ...
                        <div id="refacciones_container">
                            ...
                            <div class="refaccion_item row mb-2" data-row-id="1">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control form-control-sm refaccion_qty" name="refaccion_qty[]" value="1" min="1" data-id="1">
                                </div>
                                <div class="col-2 text-center">
                                    <span class="badge badge-secondary stock_indicator" id="stock_indicator_1">Stock: N/A</span>
                                </div>
                                <div class="col-1"></div>
                            </div>
                        </div>
                        ...
                        <template id="refaccion_template">
                            <div class="refaccion_item row mb-2">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control form-control-sm refaccion_qty" name="refaccion_qty[]" value="1" min="1">
                                </div>
                                <div class="col-2 text-center">
                                    <span class="badge badge-secondary stock_indicator">Stock: N/A</span>
                                </div>
                                <div class="col-1">
                                    <button type="button" class="btn btn-danger btn-sm remove_refaccion_btn">X</button>
                                </div>
                            </div>
                        </template>
