...
<script>
	...
	function data_func(){
		$('.edit_data').click(function(){
			uni_modal('<span class="fa fa-edit text-primary"></span> Editar Categoría de Servicios','app/views/dashboard/settings/manage_category.php?id='+$(this).attr('data-id'))
		})
	...
	$(document).ready(function(){
		...
		$('#new_data').click(function(){
			uni_modal('<span class="fa fa-plus"></span> Crear una nueva categoría de servicio','app/views/dashboard/settings/manage_category.php')
		})
	})
</script>
