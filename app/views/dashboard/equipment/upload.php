                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm" style="border-top: 3px solid #28a745;">
                            <div class="card-body">
                                ...
                                <a href="index.php?page=generate_excel_template" class="btn btn-success btn-block">
        ...
        error: function(xhr, status, error) {
            ...
            $('#upload-result').html(`
                <div class="alert alert-danger alert-dismissible fade show shadow-sm" style="border-left: 4px solid #dc3545;">
                    ...
                    <p>` + (status === 'timeout' ? 'El servidor tardó demasiado en responder. Intenta de nuevo o sube un archivo más pequeño.' : 'No se pudo conectar con el servidor. Por favor verifica tu conexión e intenta nuevamente.') + `</p>
