<?php
/**
 * app/models/Category.php - Simple CRUD Model
 */
...
class Category extends DataStore {
    ...
    public function save($data) {
        try {
            ...
            error_log("Category::save - " . $e->getMessage());
            throw $e;
        }
    }
    ...
    public function search($search) {
        $search = '%' . trim($search) . '%';
        $sql = 'SELECT * FROM categories WHERE name LIKE ? OR description LIKE ? ORDER BY name ASC LIMIT 50';
