...
$bid = function_exists('active_branch_id') ? (int)active_branch_id() : (int)($_SESSION['login_active_branch_id'] ?? 0);
$companyLogoUrl = get_company_logo_url($conn, $bid);
$companyCfg = get_company_config($conn, $bid);
?>
